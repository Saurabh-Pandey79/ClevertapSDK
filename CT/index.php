...
<form  onsubmit="return submitForm()" method="post">
  ...
  <div class="form-group">
    ...
    <div><br>
    <button type="submit" name="submit" class="btn btn-success" id="b1">Submit</button>


    <button type="button" class="login" onclick="eventCapture('login')" name="login" id="b2">Login</button>
  </div>
  <div>
    <button type="button" class="profilePush" name="profilepush" class="btn btn-success" id="b3">Profile Push</button>


    <button type="button" class="raiseEvent" onclick="eventCapture('raiseEvent')" name="raiseevent" id="b4">Raise Event</button>
  </div>
  </div>
